...
class WFunc:
    ...
    def __init__(self,**kwargs):
        ...
        self.parameters["swing_scale"]=0.0        # 0.0
        self.parameters["step_scale"]=0.2       # 0.3 height of step
        self.parameters["step_offset"]=0.6     # 0.55 hight of gate
        self.parameters["ankle_offset"]=-0.05   # 0.0
        self.parameters["vx_scale"]=0.5         # 0.5
        self.parameters["vy_scale"]=0.1         # 0.5
        self.parameters["vt_scale"]=0.1         # 0.4
